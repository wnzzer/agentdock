...
.chat-endpoint :deep(.chip-menu-panel),.chat-model :deep(.chip-menu-panel),.chat-permission :deep(.chip-menu-panel){min-width:190px;max-width:78cqw;max-height:264px;overflow-y:auto;padding:5px}
...
.chat-permission :deep(.chip-menu-panel){min-width:214px;width:max-content;max-width:min(292px,78cqw)}
...
.chat-permission nav button strong{display:block;font-size:12px;font-weight:600;color:var(--ink-soft)}
