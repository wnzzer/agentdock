...
<style scoped>
.model-picker{position:relative;min-width:0}.model-picker-input{display:flex;align-items:center;min-width:0}.model-picker-input>input{min-width:0;flex:1;padding-right:34px}.model-picker-toggle{display:grid;place-items:center;width:30px;height:30px;margin-left:-35px;border:0;border-radius:6px;background:transparent;color:#647681;cursor:pointer}.model-picker-toggle svg{transform:rotate(90deg)}.model-picker:has(.model-picker-menu) .model-picker-toggle svg{transform:rotate(270deg)}.model-picker-menu{position:absolute;z-index:30;left:0;right:0;top:calc(100% + 5px);max-height:260px;overflow:auto;padding:5px;border:1px solid var(--border);border-radius:10px;background:var(--surface);box-shadow:0 10px 28px #243b4c20}.model-picker-menu button{display:flex;align-items:center;gap:8px;width:100%;min-height:42px;padding:7px 9px;border:0;border-radius:7px;background:none;text-align:left;cursor:pointer;color:#273745}.model-picker-menu button:hover,.model-picker-menu button[aria-selected=true],.model-picker-menu button.active{background:var(--teal-soft)}.model-picker-copy{display:flex;flex-direction:column;min-width:0;flex:1}.model-picker-copy strong{font-size:12px;overflow:hidden;text-overflow:ellipsis;white-space:nowrap}.model-picker-copy code{font-size:10px;color:#84949b;overflow:hidden;text-overflow:ellipsis;white-space:nowrap}.model-picker-efforts{font-size:9px;color:var(--teal);white-space:nowrap}.model-picker-menu p{padding:10px;margin:0;font-size:11px;color:var(--muted)}
</style>
